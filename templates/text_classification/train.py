"""Fine-tune student model — copy and customize for your use case."""
...
DATA_PATH = "/tmp/tinker-datasets/my_classifier.jsonl"  # TODO: Match create_data.py
...
def main():
    ...
    run_name = f"{CONFIG.name}-{model_name_slug}-{CONFIG.lora_rank}rank-{CONFIG.learning_rate}lr-{CONFIG.batch_size}batch-{date_str}"
    log_path = f"/tmp/tinker-cookbook/{CONFIG.name}/{run_name}"
