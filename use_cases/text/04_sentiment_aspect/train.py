"""Fine-tune student model for sentiment + aspect extraction."""
...
DATA_PATH = "/tmp/tinker-datasets/sentiment_aspect.jsonl"
...
def main():
    ...
    run_name = f"sentiment_aspect-{model_name_slug}-{CONFIG.lora_rank}rank-{CONFIG.learning_rate}lr-{CONFIG.batch_size}batch-{date_str}"
    log_path = f"/tmp/tinker-cookbook/sentiment_aspect/{run_name}"
