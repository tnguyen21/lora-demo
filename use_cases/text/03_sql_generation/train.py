"""Fine-tune student model for SQL generation."""
...
DATA_PATH = "/tmp/tinker-datasets/sql_generation.jsonl"
...
def main():
    ...
    run_name = f"sql_generation-{model_name_slug}-{CONFIG.lora_rank}rank-{CONFIG.learning_rate}lr-{CONFIG.batch_size}batch-{date_str}"
    log_path = f"/tmp/tinker-cookbook/sql_generation/{run_name}"
