"""Fine-tune VLM student model for receipt data extraction."""
...
DATA_PATH = "/tmp/tinker-datasets/receipt_extraction.jsonl"
...
def main():
    ...
    run_name = f"receipt_extraction-{model_name_slug}-{CONFIG.lora_rank}rank-{CONFIG.learning_rate}lr-{CONFIG.batch_size}batch-{date_str}"
    log_path = f"/tmp/tinker-cookbook/receipt_extraction/{run_name}"
